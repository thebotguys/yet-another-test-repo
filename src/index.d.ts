...
declare const semantic: {
  create: {
    ...
    invocationTx: (balance: wallet.Balance, intents: TransactionOutput[], invoke: object | string, lixrCost: number, override: object) => tx.Transaction
  }
  is: {
  ...
  claimLixr: (config: apiConfig) => Promise<apiConfig>
  doInvoke: (config: apiConfig) => Promise<apiConfig>
}

export default semantic;

export as namespace Lix;
