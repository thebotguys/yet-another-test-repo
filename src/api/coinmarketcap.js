 ...
 * @param {string} coin - Coin name. LIX or LIXR.
 * @param {string} currency - Three letter currency symbol.
 * @return {Promise<number>} price
 */
export const getPrice = (coin = 'LIX', currency = 'usd') => {
 ...
 * @param {string[]} [coins] - Coin names. LIX or LIXR.
 * @param {string} [currency] - Three letter currency symbol.
 * @return {Promise<object>} object mapping symbol to price
 */
export const getPrices = (coins = ['LIX'], currency = 'usd') => {
